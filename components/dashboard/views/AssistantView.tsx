  ...
  return (
    <>
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_420px]">
        <section className="flex h-[calc(100dvh-220px)] min-h-[420px] max-h-[720px] flex-col rounded-3xl border border-white/10 bg-white/[0.04] p-4 sm:min-h-[480px] sm:p-6">
